...
public class UECVerificationPage {
	...
	public void fillAATDetails(String phoneNumber, String SSN, String zipCode,
							   String Pwd) {
		attTab.click();
		phoneNumberATTTextbox.sendKeys(phoneNumber);
		last4OfSSNATTTextbox.sendKeys(SSN);
		accountZipcodeATTTextbox.sendKeys(zipCode);
		accountPasswordATTTextbox.sendKeys(Pwd);
	}
}