...
public class VerizonEdgePage {
	...
	public static void addAnotherDevice()
	{
		Utilities.waitForElementVisible(BrowserSettings.driver.findElement(By.id("title_1")));
		BrowserSettings.driver.findElement(By.id("title_1")).click();
		BrowserSettings.driver.findElement(By.id("paymentOptionAddMore")).click();
	}

	public static void continueAfterOptionPage()
	{
		Utilities.waitForElementVisible(BrowserSettings.driver.findElement(By.id("paymentOptionContinueButton")));
		BrowserSettings.driver.findElement(By.id("paymentOptionContinueButton")).click();
	}
