...
public class UECAddLinesPage extends RetailBaseClass {
	...
	public void clickCheckboxForParticularPhoneNumber5411(String phoneNumber) {
		String formattedPhoneNumber = CommonFunction
				.getFormattedPhoneNumber_5411(phoneNumber);
		driver.findElement(By.xpath("//span[contains(text(),'Mobile Number:  "+formattedPhoneNumber+"')]")).click();
