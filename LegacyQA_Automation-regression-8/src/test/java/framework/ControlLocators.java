...
public class ControlLocators {
    ...
    public static final String VERIZON_PLAN_NAME = "//section[@class='pd-wrapper clearfix']/div[1]/h1";
    ...
    public static final String COMMON_CONTINUE_BUTTON = "continueButton";
    ...
    public static final String MONTHLY_RECURRING_FEE_CART = ".//td[contains(text(),'Monthly Recurring Fee')]/following-sibling::td/strong";
    public static final String TOTAL_DUE_TODAY = ".//h3[contains(text(),'Total Due Today')]/parent::th/following-sibling::th/h3";
    public static final String ATT_NEXT_12_TEXT = "//span[contains(text(),'AT&T Next 12')]";
    ...
    public static final String DUE_AMOUNT_FOR_DEVICE1 = "(//span[@class='grey']/parent::td/following-sibling::td[1])";
    public static final String DUE_AMOUNT_FOR_DEVICE2 = "(//span[@class='grey']/parent::td/following-sibling::td[1])[2]";
    public static final String TOTAL_DUE_MONTHLY_VALUE = "(//h3[contains(text(),'Total Due Monthly:')]/parent::th/following-sibling::th)[2]/child::h3";
    ...
    public static final String INSTALLMENTAX_TEXT = "(//td[contains(text(),'Installment Tax')])[1]";
    ...
    public static final String SUBTOTAL_BY_TARGET = "(//h3[contains(text(),'Current Charges To Be Billed By:Target')]/following-sibling::div/table/tbody/tr[2]/td[4])";
...
//    public static final String DEACTIVATE_PHONE_CHECKBOX ="(//*[contains(@id,'%s')]/td[4]/preceding-sibling::td[3])[%d]";
    ...
    public static final String EVENTS_LIST = "html/body/form[2]/table[1]/tbody/child::*";
    ...
    public static final String INSTALLMENT_CONTRACT_ERROR="//p[contains(text(),'We're sorry there are issues with the system and we are unable to process the guest's order. Please refund any tender collected by the guest in the POS.']";
...
public static final String NEXT_18_MONTH = "radio-choice-7";
    public static final String RSG_TIMEOUT_CONFIGURATOR="1422";
    public static final String GENERAL_LETS_TALK_FAQ="737";
    public static final String WIDGET_ACTIVE="//input[@name='widgDefaultActive']";
    public static final String MODIFY_RECORD="//input[@name='modtype']";
    public static final String EDIT_BRAND="Edit for Brands(1)";
    public static final String EDIT_WIDGET="Edit Widget";
    public static final String WIDGET_ACTIVE_IN_BRAND="//input[@name='widgbActive']";
    public static final String ATT_TERMANDCONDITION_CONTINUE_BUTTON = "//button[contains(text(),'continue')]";
}
