...
public class Constants {
    ...
    public static final String DEFAULT_ACCOUNT_VALIDATION_PTN_NUMBER = "8125453522";
   // public static final String DEFAULT_ACCOUNT_VALIDATION_PTN_NUMBER = "6157157755";
    ...
    public static final String RESERVE_SUBSCRIBER_NUMBER_FAILED = "ReserveSubscriberNumber Failed";
    public static final String EXCEPTION_CODE_004 = "Exception Code: 004";
    public static final String RESERVE_SUBSCCRIBER_NUMBER_EXCEPTION_MESSASE = "Exception Message: Invalid/Unsuccessful XML Response - ReserveSubscriberNumber";
    public static final String RESERVE_CONTRACT_INDENTIFIER_FAILED="Exception Message: Invalid/Unsuccessful XML Response - ReserveContractIdentifier";
    public static final String ORDER_VALIDATION_FAILED="Order Validation failed. Parking not run.";

    //region Install Contract Error message
    public static final String INTALLLMENT_CONTRACT_ERROR="We're sorry there are issues with the system and we are unable to process the guest's order. Please refund any tender collected by the guest in the POS.";
//endregion Install Contract Error message
}